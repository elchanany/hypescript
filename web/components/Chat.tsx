  ...
  return (
    <>
      ...
      {byokOpen && <section className="chat-ai-settings" aria-label="הגדרות AI">
        ...
        {!canChooseProvider ? <div className="chat-ai-locked"><Lock size={16} /><span><strong>רוצה לבחור מודל AI מתקדם או לחבר מפתחות אישיים? ✨</strong><small>שדרג ל-Pro וקבל גישה מלאה ל-GPT-4o, Claude 3.5 Sonnet, Gemini 1.5 Pro, חיבור מפתחות BYOK ללא מגבלות ושליטה מלאה בעורך!</small></span><a href="/account#plans" className="btn sm primary">שדרג עכשיו ל-Pro 🚀</a></div> : <>
