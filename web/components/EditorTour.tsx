...
const STEPS = [
  ...
  { target: "focus-mode", title: "מצב שיחה ייעודי", text: "כפתור זה פותח חוויית שיחה מלאה במרכז המסך בסגנון ChatGPT, עם נגן וידאו אינטראקטיבי שמוטמע ישירות בתוך הודעות הסוכן." },
  ...
  { target: "tools", title: "ספריית היצירה", text: "מדיה, טקסט, כתוביות, מעברים ואפקטים נמצאים בסרגל הזה. תמיד אפשר לחזור להדרכה מכפתור העזרה (?)." },
] as const;
