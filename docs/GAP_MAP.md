...
### P2 (הבא)
- **AG-2**: PARTIAL — clip split/trim/move/add + video tracks + enabled/volume + track rename/lock/mute דרך CommandBus מהסוכן; height/reorder ופעולות UI נוספות לאיחוד
