...
## Corpus Check
- 226 files · ~422,475 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1592 nodes · 3386 edges · 114 communities (96 shown, 18 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `58b4c947`
...
Cohesion: 0.09
Nodes (22): AGENT_COMMANDS, bool, CommandContext, CommandDef, CommandPermission, CommandPresentation, CommandSchema, id (+14 more)

### Community 2 - "ffmpeg.ts"
Cohesion: 0.13
Nodes (25): uid(), extOf(), extractAssembledAudio(), extractAudio(), extractAudioChunks(), extractAudioSegment(), extractFrame(), ffQueue (+17 more)

### Community 3 - "project.ts"
Cohesion: 0.17
Nodes (28): SOURCE_COLORS, Timeline(), TYPE_ICON, migrateClips(), migrateState(), totalDur(), captionLocked(), captionTrack() (+20 more)

### Community 4 - "tools.ts"
Cohesion: 0.08
Nodes (26): clipsSummary(), dispatch(), ensureTrackId(), fetchTranscribeConfigured(), fmt(), mainVideo(), readTranscribeModelPref(), readTranscribePref() (+18 more)
...
Cohesion: 0.16
Nodes (22): assembledDuration(), AssembleOpts, assembleTranscript(), formatTranscriptLines(), assembledStart(), clipDur(), clipEnabled(), mediaById() (+14 more)
...
Cohesion: 0.13
Nodes (21): COMMAND_ICONS, download(), EditorPage(), kindOf(), probeDuration(), LeftTab, TABS, ToolRail() (+13 more)

### Community 16 - "model.ts"
Cohesion: 0.12
Nodes (16): CORNERS, DragState, Handle, PreviewOverlays(), ensureBuiltinCommands(), addClip(), assembledToSource(), splitClip() (+8 more)
...
Cohesion: 0.22
Nodes (15): isSpeechWord(), buildCues(), CaptionMode, Cue, endsPhrase(), endsSentence(), formatCueText(), mapToEdited() (+7 more)
...
### Community 67 - "storage.ts"
Cohesion: 0.29
Nodes (16): createProjectWithPolicy(), ensureProjectPolicy(), getProjectPolicy(), saveProjectPolicy(), ProjectMetaV2, createProject(), deleteProject(), ensureProject() (+8 more)
...
Cohesion: 0.10
Nodes (23): Conversation, CANCELLED_RESULT, isToolHistoryValid(), repairToolMessages(), AgentEvents, AgentRunner, formatLlmError(), formatToolError() (+15 more)

### Community 100 - "canvasCoords.ts"
Cohesion: 0.29
...
Cohesion: 0.16
Nodes (14): CaptionsPanel(), TextPanel(), TopBar(), Button(), ContextMenu(), CtxItem, ICON, Section() (+6 more)

### Community 108 - "elevenlabs/normalize.ts"
Cohesion: 0.47
Nodes (4): ElevenLabsSttRaw, ElevenLabsWordRaw, mapTokenType(), normalizeElevenLabsStt()

### Community 109 - "normalizeSupabaseUrl"
Cohesion: 0.30
...
## Knowledge Gaps
- **501 isolated node(s):** `track-edit.sh script`, `runtime`, `maxDuration`, `runtime`, `runtime` (+496 more)
...
- **Why does `Overlay` connect `Clip` to `VideoPreview.tsx`, `commands.ts`, `ffmpeg.ts`, `project.ts`, `tools.ts`, `Chat.tsx`, `InspectorPanel.tsx`, `model.ts`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `Clip` connect `Clip` to `VideoPreview.tsx`, `commands.ts`, `ffmpeg.ts`, `project.ts`, `tools.ts`, `Chat.tsx`, `models.ts`, `graph.ts`, `InspectorPanel.tsx`, `app/page.tsx`, `model.ts`, `graph.integration.test.ts`, `subtitlesEdl.ts`, `clipFilter.ts`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `runtime.ts` to `model.ts`, `Chat.tsx`?**
