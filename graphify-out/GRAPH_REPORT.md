...
## Corpus Check
- 226 files · ~421,126 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1591 nodes · 3391 edges · 111 communities (94 shown, 17 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b5af02db`
...
### Community 15 - "projects/types.ts"
Cohesion: 0.10
...
### Community 104 - "ThemeProvider.tsx"
Cohesion: 0.29
...
- **Why does `Overlay` connect `Timeline.tsx` to `InspectorPanel.tsx`, `commands.ts`, `graph.ts`, `tools.ts`, `VideoPreview.tsx`, `Chat.tsx`, `ffmpeg.ts`, `RenderBackend.ts`, `app/page.tsx`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `runtime.ts` to `Chat.tsx`, `agent/types.ts`, `app/page.tsx`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `Clip` connect `Timeline.tsx` to `InspectorPanel.tsx`, `commands.ts`, `graph.ts`, `tools.ts`, `VideoPreview.tsx`, `Chat.tsx`, `ffmpeg.ts`, `graph.integration.test.ts`, `RenderBackend.ts`, `subtitlesEdl.ts`, `clipFilter.ts`, `app/page.tsx`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
