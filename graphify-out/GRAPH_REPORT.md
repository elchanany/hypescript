...
## Corpus Check
- 226 files · ~422,477 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1592 nodes · 3292 edges · 106 communities (88 shown, 18 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `69397c90`
...
Cohesion: 0.35
Nodes (15): SOURCE_COLORS, Timeline(), TYPE_ICON, clipEnabled(), totalDur(), primaryVideoTrackId(), sortedTracks(), videoTrack() (+7 more)
...
Cohesion: 0.15
Nodes (22): Updater, useEditor(), captionStyleToCss(), DEFAULT_CAPTION_STYLE, normalizeCaptionStyle(), migrateClips(), migrateState(), audioMuted() (+14 more)

### Community 4 - "tools.ts"
Cohesion: 0.07
Nodes (28): clipsSummary(), dispatch(), fetchTranscribeConfigured(), fmt(), mainVideo(), MODE_PROMPTS, readTranscribeModelPref(), readTranscribePref() (+20 more)
...
Cohesion: 0.12
Nodes (24): clipVolume(), mediaById(), CaptionLayout, captionLayoutForTarget(), captionYFraction(), renderCaptionPng(), roundRect(), wrapLines() (+16 more)
...
Cohesion: 0.08
Nodes (41): ClipInspector(), InspectorFocus, InspectorPanel(), KIND, num(), OverlayInspector(), SubInspector(), titleFor() (+33 more)
...
Cohesion: 0.27
Nodes (12): assembledToSource(), clipDur(), splitClip(), trimClip(), closeGap(), isGapClip(), makeGap(), removeClipLeaveGap() (+4 more)
...
Cohesion: 0.07
Nodes (62): DashboardPage(), DialogState, fmtDate(), fmtRelativeHe(), ProjectCard(), userAvatarUrl(), userLabel(), COMMAND_ICONS (+54 more)

### Community 32 - "agent/normalize.ts"
Cohesion: 0.43
...
### Community 61 - "uid"
Cohesion: 0.20
Nodes (13): deleteClipRange(), deleteClipsAt(), intersectClipsWithSpeech(), keepSourceRange(), snapSpeechToWords(), uid(), makeImageOverlay(), makeTextOverlay() (+5 more)
...
Cohesion: 0.42
Nodes (9): addConversation(), Conversation, emptyConversation(), emptyStore(), isPlaceholderTitle(), migrateChatStore(), newId(), titleFromItems() (+1 more)
...
Cohesion: 0.18
Nodes (11): AgentEvents, AgentRunner, formatLlmError(), formatToolError(), isChunkLoadError(), LOOP_GUARDS, MUTATING_TOOLS, AgentContext (+3 more)
...
- **Why does `Overlay` connect `VideoPreview.tsx` to `Timeline.tsx`, `commands.ts`, `ffmpeg.ts`, `project.ts`, `tools.ts`, `Chat.tsx`, `graph.ts`, `InspectorPanel.tsx`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `runtime.ts` to `Chat.tsx`, `providers.ts`?**
