...
## Corpus Check
- 385 files · ~538,597 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3122 nodes · 6625 edges · 204 communities (167 shown, 37 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 44 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9227367c`
...
Cohesion: 0.10
Nodes (24): Conversation, CANCELLED_RESULT, isToolHistoryValid(), repairToolMessages(), AgentEvents, agentLoopGuard(), AgentRunner, formatLlmError() (+16 more)
...
Cohesion: 0.06
Nodes (82): DashboardPage(), DialogState, fmtDate(), fmtRelativeHe(), ProjectCard(), userAvatarUrl(), userLabel(), COMMAND_ICONS (+74 more)
...
Cohesion: 0.21
Nodes (16): CloudStatus, SettingsPage(), ApiConfigShape, flattenApiConfig(), getProviderStatus(), getProviderStatuses(), isProviderConfigured(), isProviderUsable() (+8 more)
...
Cohesion: 0.04
Nodes (63): analysisBySource, buildImageBrandBrief(), buildImagePrompt(), captureFrameMode, clipsSummary(), dispatch(), ensureTrackId(), fetchTranscribeConfigured() (+55 more)
...
Cohesion: 0.10
Nodes (51): VolumeX, ClipInspector(), InspectorFocus, InspectorPanel(), KIND, num(), OverlayInspector(), SubInspector() (+43 more)
...
Cohesion: 0.10
Nodes (33): GET(), runtime, maxDuration, POST(), runtime, maxDuration, POST(), runtime (+25 more)
...
Cohesion: 0.05
Nodes (59): findRanges(), FINALS, getOpcodes(), lcsMatches(), normalizeHebrew(), Op, scriptKeepMask(), EnergyProfile (+51 more)

### Community 32 - "Clip"
Cohesion: 0.09
Nodes (28): ChatProps, Props, Props, Props, Props, EditorSnapshot, Updater, AgentContext (+20 more)
...
Cohesion: 0.11
Nodes (30): useEditor(), CaptionBg, CaptionPosition, captionStyleToCss(), DEFAULT_CAPTION_STYLE, normalizeCaptionStyle(), migrateClips(), migrateState() (+22 more)
...
Cohesion: 0.18
Nodes (16): SpectralDistribution, computeEnvelope(), computeSpectral(), dbAt(), ENVELOPE_DEFAULTS, EnvelopeOptions, fftRadix2(), floorAt() (+8 more)
...
Cohesion: 0.12
Nodes (24): HebrewToken, AudioCalibration, percentileRank(), band(), CLASSIFY_DEFAULTS, classifyGap(), ClassifyOptions, describeEvent() (+16 more)
...
### Community 67 - "planScriptCut"
Cohesion: 0.14
Nodes (19): calibrateFromTranscript(), CalibrationOptions, DEFAULTS, Distribution, EMPTY, fallbackCalibration(), analyze(), Condition (+11 more)
...
### Community 98 - "ui.tsx"
Cohesion: 0.12
Nodes (19): CaptionsPanel(), SlashCmd, AppIcon, ChevronDown, FileDown, FileUp, Trash2, Type (+11 more)
...
### Community 100 - "elevenlabs/normalize.test.ts"
Cohesion: 0.32
...
Cohesion: 0.07
Nodes (50): Chat(), fmtTc(), Item, KIND_ICON, MODES, now(), SLASH, TOOL_ICON (+42 more)
...
Cohesion: 0.13
Nodes (31): alignBanded(), alignBlock(), AlignmentReport, AlignOptions, AlignPair, alignTokens(), Anchor, DEFAULTS (+23 more)
...
Cohesion: 0.14
Nodes (15): BeatAudioPlayer(), ChatMediaCard(), fmt(), LABEL, MKind, Props, VideoPlayer(), ExternalLink (+7 more)
...
Cohesion: 0.07
Nodes (34): features, metadata, plans, useCases, calculateLayout(), EditorTour(), STEPS, TourLayout (+26 more)

### Community 128 - "commands.builtin.ts"
Cohesion: 0.16
Nodes (23): ensureBuiltinCommands(), addClip(), assembledToSource(), splitClip(), uid(), clampOverlayTransform(), imageOverlayGeometry(), ImageOverlayPreset (+15 more)
...
Cohesion: 0.11
Nodes (19): @aws-sdk/s3-request-presigner, @base-ui/react, class-variance-authority, @ffmpeg/ffmpeg, next, @phosphor-icons/react, react, @supabase/ssr (+11 more)

### Community 131 - "account/page.tsx"
Cohesion: 0.13
Nodes (14): AccountPage(), BillingStatus, gb(), AccountPreferences(), State, CalendarDays, CreditCard, Download (+6 more)

### Community 137 - "r2.ts"
Cohesion: 0.13
Nodes (27): GET(), DELETE(), GET(), GET(), POST(), ClipInput, parseClips(), POST() (+19 more)
...
Cohesion: 0.17
Nodes (16): CheckCircle2, Info, X, XCircle, ICONS, ToastHost(), dismissToast(), emit() (+8 more)
...
Cohesion: 0.11
Nodes (27): captionTokensFromTranscript(), ScriptCaptionResult, TimedWord, auditCaptions(), BIND_NEXT, BREAK_BEFORE, breakScore(), buildCaptionCues() (+19 more)
...
Cohesion: 0.14
Nodes (27): maxDuration, POST(), runtime, maxDuration, POST(), runtime, DELETE(), GET() (+19 more)
...
### Community 153 - "providers.ts"
Cohesion: 0.21
Nodes (15): anthropicParts(), asText(), callAnthropic(), callGemini(), callOpenAICompat(), CONFIG, geminiParts(), normalizeProviderUsage() (+7 more)
...
Cohesion: 0.14
Nodes (20): DELETE(), GET(), PATCH(), GET(), GET(), context(), GET(), PUT() (+12 more)
...
### Community 166 - "web/package.json"
Cohesion: 0.40
...
Cohesion: 0.19
Nodes (17): POST(), runtime, DELETE(), POST(), secretMatches(), POST(), ensureBootstrapSystemOwner(), normalizeSupabaseUrl() (+9 more)
...
- **Why does `Clip` connect `Clip` to `commands.builtin.ts`, `subtitlesEdl.ts`, `project.ts`, `ffmpeg.ts`, `Chat.tsx`, `timelineFrame.ts`, `app/page.tsx`, `catalog.test.ts`, `graph.integration.test.ts`, `tools.ts`, `model.ts`, `commands.ts`, `editAudit.ts`, `models.ts`, `scriptPlan.ts`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `Provider` connect `runtime.ts` to `providers.ts`, `Chat.tsx`, `settings/page.tsx`, `suggestions/route.ts`?**
