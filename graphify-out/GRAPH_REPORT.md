...
## Corpus Check
- 386 files · ~538,901 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3126 nodes · 6637 edges · 206 communities (169 shown, 37 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 44 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f723027d`
...
2. `EditorPage()` - 62 edges
3. `Clip` - 61 edges
4. `ensureBuiltinCommands()` - 41 edges
5. `Overlay` - 37 edges
6. `clipDur()` - 36 edges
7. `EditorApi` - 35 edges
8. `isGapClip()` - 35 edges
9. `MediaAsset` - 34 edges
10. `uid()` - 33 edges
...
Cohesion: 0.23
Nodes (17): assembledWords(), CaptionBuildOpts, CaptionMode, edlToCues(), edlToCuesWithScript(), edlToSubs(), edlToSubsWithScript(), endsPhrase() (+9 more)
...
Cohesion: 0.06
Nodes (44): Conversation, CANCELLED_RESULT, isToolHistoryValid(), repairToolMessages(), anthropicParts(), asText(), callAnthropic(), callGemini() (+36 more)
...
Cohesion: 0.06
Nodes (73): DashboardPage(), DialogState, fmtDate(), fmtRelativeHe(), ProjectCard(), userAvatarUrl(), userLabel(), Clapperboard (+65 more)
...
Cohesion: 0.20
Nodes (17): CloudStatus, SettingsPage(), ApiConfigShape, flattenApiConfig(), getProviderStatus(), getProviderStatuses(), isProviderConfigured(), isProviderUsable() (+9 more)
...
Cohesion: 0.04
Nodes (57): analysisBySource, buildImageBrandBrief(), buildImagePrompt(), captureFrameMode, clipsSummary(), dispatch(), ensureTrackId(), fetchTranscribeConfigured() (+49 more)
...
Cohesion: 0.09
Nodes (38): ClipInspector(), InspectorFocus, InspectorPanel(), KIND, num(), OverlayInspector(), SubInspector(), titleFor() (+30 more)
...
Cohesion: 0.10
Nodes (31): GET(), runtime, GET(), runtime, maxDuration, POST(), runtime, maxDuration (+23 more)
...
Cohesion: 0.09
Nodes (28): findRanges(), FINALS, getOpcodes(), lcsMatches(), normalizeHebrew(), Op, scriptKeepMask(), buildKeepIntervals() (+20 more)

### Community 32 - "Clip"
Cohesion: 0.09
Nodes (32): ChatProps, Props, Props, Props, Props, EditorSnapshot, Updater, AgentContext (+24 more)
...
Cohesion: 0.12
Nodes (24): COMMAND_ICONS, download(), EditorPage(), kindOf(), probeDuration(), ChevronsUpDown, Lock, Volume2 (+16 more)
...
Cohesion: 0.08
Nodes (39): AudioCalibration, CalibrationOptions, DEFAULTS, Distribution, EMPTY, percentileRank(), SpectralDistribution, Condition (+31 more)
...
### Community 63 - "scriptPlan.ts"
Cohesion: 0.14
Nodes (22): AlignmentReport, HebrewToken, calibrateFromTranscript(), describeCalibration(), fallbackCalibration(), analyze(), isRemovable(), NonSpeechEvent (+14 more)
...
Cohesion: 0.14
Nodes (23): analyzeAudio(), cache, EnergyProfile, findSilences(), fp(), auditCutQuality(), CutQualityReport, deleteClipRange() (+15 more)
...
### Community 98 - "ui.tsx"
Cohesion: 0.14
Nodes (17): CaptionsPanel(), SlashCmd, AppIcon, ChevronDown, FileDown, FileUp, Type, Wand2 (+9 more)

### Community 99 - "ffmpeg.ts"
Cohesion: 0.12
Nodes (28): uid(), extOf(), extractAssembledAudio(), extractAudio(), extractAudioChunks(), extractAudioSegment(), extractFrame(), ffQueue (+20 more)

### Community 100 - "account/page.tsx"
Cohesion: 0.09
Nodes (22): AccountPage(), BillingStatus, gb(), AdminData, PriceMap, AccountPreferences(), State, Activity (+14 more)

### Community 101 - "Chat.tsx"
Cohesion: 0.07
Nodes (48): Chat(), fmtTc(), Item, KIND_ICON, MODES, now(), SLASH, TOOL_ICON (+40 more)

### Community 102 - "commands.builtin.ts"
Cohesion: 0.11
Nodes (48): Timeline(), ensureBuiltinCommands(), addClip(), assembledToSource(), clipAudioFades(), clipDur(), clipVisualFades(), normalizeFades() (+40 more)
...
Cohesion: 0.16
Nodes (13): BeatAudioPlayer(), ChatMediaCard(), fmt(), LABEL, MKind, Props, VideoPlayer(), Image (+5 more)
...
Cohesion: 0.09
Nodes (29): ClipPatch, CreativePanel(), FADES, LOOKS, Search, FFMPEG_XFADE, EFFECT_CATEGORIES, EffectCategory (+21 more)
...
### Community 118 - "VideoPreview.tsx"
Cohesion: 0.12
Nodes (21): CORNERS, DragState, Handle, PreviewOverlays(), ContextMenu(), PreviewHandle, VideoPreview, defaultCanvasFor() (+13 more)
...
Cohesion: 0.18
Nodes (17): chooseJoinPoint(), clampTime(), crossingTime(), findValley(), frameIndex(), JoinPoint, RefinedBoundary, refineOffset() (+9 more)
...
Cohesion: 0.09
Nodes (28): features, metadata, plans, useCases, AudioWaveform, BadgeCheck, Blend, Captions (+20 more)

### Community 128 - "captionBurn.ts"
Cohesion: 0.23
Nodes (14): CaptionBg, CaptionPosition, captionStyleToCss(), DEFAULT_CAPTION_STYLE, normalizeCaptionStyle(), collapseProgressiveForBurn(), CaptionLayout, captionLayoutForTarget() (+6 more)
...
Cohesion: 0.11
Nodes (19): @base-ui/react, class-variance-authority, @ffmpeg/ffmpeg, geist, next, @phosphor-icons/react, react, @supabase/ssr (+11 more)

### Community 131 - "EditorTour.tsx"
Cohesion: 0.29
Nodes (7): calculateLayout(), EditorTour(), STEPS, TourLayout, ArrowLeft, ArrowRight, X

### Community 137 - "r2.ts"
Cohesion: 0.14
Nodes (26): GET(), POST(), POST(), secretMatches(), ClipInput, parseClips(), POST(), dynamic (+18 more)
...
Cohesion: 0.13
Nodes (23): AtSign, LayoutGrid, List, Loader2, Plus, TriangleAlert, Upload, UploadProgressCard() (+15 more)
...
Cohesion: 0.18
Nodes (15): CheckCircle2, Info, XCircle, ICONS, ToastHost(), dismissToast(), emit(), items (+7 more)

### Community 142 - "auth/config.ts"
Cohesion: 0.22
Nodes (15): GET(), classifyPublicKey(), decodeJwtPayload(), getAuthDiagnostics(), getRawPublicKey(), getSupabasePublicConfig(), keyLenTooShort(), normalizeSupabaseUrl() (+7 more)
...
Cohesion: 0.12
Nodes (26): auditCaptions(), BIND_NEXT, BREAK_BEFORE, breakScore(), buildCaptionCues(), BuildCuesOptions, CAPTION_POLICY, CaptionAudit (+18 more)

### Community 148 - "agent-build.mjs"
Cohesion: 0.15
Nodes (14): alive(), args, child, conflict, data, entry, prune(), readRegistry() (+6 more)

### Community 149 - "suggestions/route.ts"
Cohesion: 0.18
Nodes (21): maxDuration, POST(), runtime, maxDuration, POST(), runtime, DELETE(), GET() (+13 more)
...
Cohesion: 0.21
Nodes (13): ContinueInner(), LoginInner(), Tab, AuthDiagnostics, authIssueMessage(), postLoginPath(), postLoginPathForUser(), waitForSession() (+5 more)
...
Cohesion: 0.09
Nodes (38): AppIconProps, ArrowLeftRight, BetweenHorizontalStart, ChevronUp, Command, Film, FolderOpen, Layers (+30 more)
...
### Community 166 - "subtitles.ts"
Cohesion: 0.20
Nodes (16): edlToSrt(), buildCues(), buildSrt(), CaptionMode, Cue, endsPhrase(), endsSentence(), formatCueText() (+8 more)
...
### Community 186 - "getSupabaseServiceClient"
Cohesion: 0.17
Nodes (18): GET(), GET(), context(), GET(), PUT(), POST(), runtime, DELETE() (+10 more)
...
### Community 193 - "providers/policy.ts"
Cohesion: 0.32
...
### Community 197 - "keys.ts"
Cohesion: 0.29
Nodes (6): DEFAULT_DATA_MODE_PREF, GROQ_KEY, OPENAI_KEY, PROVIDER_PREF, TRANSCRIBE_MODEL_PREF, TRANSCRIBE_PREF
...
## Knowledge Gaps
- **1114 isolated node(s):** `track-edit.sh script`, `name`, `version`, `private`, `type` (+1109 more)
...
- **Why does `requireCloudUser()` connect `requireCloudUser` to `images.ts`, `r2.ts`, `auth/config.ts`, `suggestions/route.ts`, `transcribe/route.ts`, `lemon.ts`, `getSupabaseServiceClient`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `Clip` connect `Clip` to `subtitlesEdl.ts`, `app/page.tsx`, `clipFilter.ts`, `Chat.tsx`, `commands.builtin.ts`, `ffmpeg.ts`, `catalog.test.ts`, `graph.integration.test.ts`, `tools.ts`, `model.ts`, `commands.ts`, `editAudit.ts`, `VideoPreview.tsx`, `scriptPlan.ts`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `Provider` connect `runtime.ts` to `Chat.tsx`, `settings/page.tsx`, `suggestions/route.ts`?**
