...
## Corpus Check
- 226 files · ~422,931 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1592 nodes · 3392 edges · 114 communities (96 shown, 18 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9710720a`
...
Cohesion: 0.16
Nodes (29): SOURCE_COLORS, Timeline(), TYPE_ICON, migrateClips(), migrateState(), clipOpacity(), totalDur(), captionLocked() (+21 more)
...
Cohesion: 0.11
Nodes (25): COMMAND_ICONS, download(), EditorPage(), kindOf(), probeDuration(), LeftTab, TABS, ToolRail() (+17 more)

### Community 3 - "VideoPreview.tsx"
Cohesion: 0.22
...
Cohesion: 0.10
Nodes (34): clipVolume(), mediaById(), extOf(), extractAssembledAudio(), extractAudio(), extractAudioChunks(), extractAudioSegment(), extractFrame() (+26 more)
...
### Community 15 - "InspectorPanel.tsx"
Cohesion: 0.15
Nodes (19): CaptionsPanel(), ClipInspector(), InspectorFocus, InspectorPanel(), KIND, num(), OverlayInspector(), SubInspector() (+11 more)

### Community 16 - "model.ts"
Cohesion: 0.15
Nodes (24): assembledDuration(), AssembleOpts, assembleTranscript(), formatTranscriptLines(), ensureBuiltinCommands(), addClip(), assembledStart(), assembledToSource() (+16 more)
...
### Community 19 - "Clip"
Cohesion: 0.12
Nodes (23): ChatProps, Props, Props, Props, Props, EditorSnapshot, Updater, AgentContext (+15 more)
...
### Community 35 - "projects/types.ts"
Cohesion: 0.19
...
### Community 107 - "providers/policy.ts"
Cohesion: 0.29
...
- **Why does `Overlay` connect `Clip` to `project.ts`, `commands.ts`, `VideoPreview.tsx`, `tools.ts`, `Chat.tsx`, `ffmpeg.ts`, `overlay.ts`, `InspectorPanel.tsx`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `Clip` connect `Clip` to `project.ts`, `commands.ts`, `app/page.tsx`, `VideoPreview.tsx`, `tools.ts`, `Chat.tsx`, `models.ts`, `ffmpeg.ts`, `InspectorPanel.tsx`, `model.ts`, `graph.integration.test.ts`, `subtitlesEdl.ts`, `clipFilter.ts`?**
